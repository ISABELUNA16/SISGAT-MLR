<?php
/* Smarty version 3.1.30, created on 2017-07-13 11:17:37
  from "C:\wamp\www\SISGAT\views\templates\productoslistado.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_59673ab1baab93_64631635',
...
function content_59673ab1baab93_64631635 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!DOCTYPE html>
<html>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h4>LISTADO <span class="w3-opacity w3-medium">GENERAL DE PRODUCTOS</span></h4>
                        </div> <br>
                        <div class="w3-container w3-grey">
                        <div class="w3-row">    
                           <br>     
                            <button class="w3-button w3-red" style="margin-bottom: 20px; margin-right: 5px;" onclick="location.href='?action=productos'">Cancelar <i class="fa fa-exclamation-circle"></i></button>
