<?php
/* Smarty version 3.1.30, created on 2017-07-13 11:33:07
  from "C:\wamp\www\SISGAT\views\templates\clientesnuevo.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_59673e53b283b8_24378714',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '9915fdc91ea860ca07569de92df6308216a4388e' => 
    array (
      0 => 'C:\\wamp\\www\\SISGAT\\views\\templates\\clientesnuevo.tpl',
      1 => 1499920062,
      2 => 'file',
    ),
  ),
...
function content_59673e53b283b8_24378714 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!DOCTYPE html>
<html>
  <head>
  ...
  <body class="w3-light-grey">
    ...
    <div class="w3-main" style="margin-left:300px;margin-top:43px;">
      ...
      <div  class="w3-dark-grey w3-padding-32 w3-margin-bottom">
        <div class="w3-container">
          <h4>Nuevo <span class="w3-opacity w3-medium">Cliente</span></h4>
          <input type="text" name="" class="w3-input w3-thrid" placeholder="Razón Social" maxlength="150" autofocus>  <br>        
          <div class="w3-row">
            <input type="text" name="" class="w3-input w3-col m5" placeholder="N° de RUC" style="margin-right: 3px;">
            <input type="text" name="" class="w3-input w3-col m5" placeholder="Contacto">
          </div>   <br>
            <div class="w3-row">         
              <input type="text" name="" class="w3-input w3-col m4" placeholder="Teléfono Contacto" style="margin-right: 3px;">
              <input type="text" name="" class="w3-input w3-col m4" placeholder="Email " style="margin-right: 3px;"> 
              <input type="text" name="" class="w3-input w3-col m2" placeholder="Dirección">      
            </div>
        </div> 
        <br>
          <button class="w3-button w3-blue">Guardar  <i class="fa fa-save"></i></button>
          <button class="w3-button w3-red">Cancelar <i class="fa fa-exclamation-circle"></i></button>
      </div>
    </div>
