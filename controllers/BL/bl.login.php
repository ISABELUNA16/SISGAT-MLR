                ...
                if(!empty($_POST['contrasena']))
                {
                    ...
                    else
                    {
                        ...
                        if($_SESSION['estado']==0)
                        {
                            ...
                            $view->assign(array('clase' => 'class="texto-mensaje-success texto-centro texto-14"', 'mensaje' => 'Bienvenido al SISGAT <br>' .$_SESSION['nombres'], 'usuario' => '', 'contrasena' => '', 'focus' => 'autofocus', 'focps' => '', 'icono' => '', 'url' => '<meta http-equiv="refresh" content="1;url=?action=principal">', 'img'=>'<img src="views/images/cargar.gif" width="60px" height="60px">'));
